...
ingest candig-example-data/registry.db mock2 /tmp/clinical_metadata_tier1.json
ingest candig-example-data/registry.db mock2 /tmp/pipeline_metadata_tier1.json
